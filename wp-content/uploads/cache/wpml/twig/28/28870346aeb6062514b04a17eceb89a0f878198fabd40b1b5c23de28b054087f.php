...
class __TwigTemplate_4689acee36774fe002c44a26bdddcd9348a773ce84e1d4cb8fe22837c9acb82a extends Twig_Template
{
...
<p>
    <input type=\"checkbox\" id=\"wpml-ls-show-in-shortcode-actions\" name=\"statics[shortcode_actions][show]\" value=\"1\"
                   ...
                   ";
        // line 5
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "statics", array()), "shortcode_actions", array()), "show", array())) {
    ...
    <label for=\"wpml-ls-show-in-shortcode-actions\">";
        // line 7
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "shortcode_actions", array()), "show", array()), "html", null, true);
        echo "</label>
</p>
...
<div class=\"js-wpml-ls-shortcode-actions-toggle-target alignleft";
        // line 24
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "statics", array()), "shortcode_actions", array()), "show", array()) != 1)) {
            echo " hidden";
        }
        echo "\">
    ...
    {
        return new Twig_Source("", "section-shortcode-action.twig", "/Users/armi/Code/projects/coccode/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/section-shortcode-action.twig");
    }
}
