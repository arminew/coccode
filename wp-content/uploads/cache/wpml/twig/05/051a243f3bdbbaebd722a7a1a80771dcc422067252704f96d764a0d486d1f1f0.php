...
/* table-slots.twig */
class __TwigTemplate_a1e9f546ff8565e35a69d6bb23ac5ad1dde09c94aee21edecf2ad7457544e606 extends Twig_Template
{
...
";
        // line 8
        if (twig_in_filter((isset($context["slug"]) ? $context["slug"] : null), array(0 => "footer", 1 => "post_translations"))) {
            // line 9
            echo "    ";
            $context["label_action"] = $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "misc", array()), "label_action", array());
        } else {
            // line 11
            echo "    ";
            $context["label_action"] = $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "misc", array()), "label_actions", array());
        }
        // line 13
        echo "
<table id=\"";
    ...
    <tr>
        ...
        echo ">";
        echo twig_escape_filter($this->env, (isset($context["label_action"]) ? $context["label_action"] : null), "html", null, true);
        echo "</th></tr>
    </thead>
    <tbody>
    ";
...
(isset($context["slot_type"]) ? $context["slot_type"] : null), "slot_settings" =>             // line 27
...
(isset($context["slots"]) ? $context["slots"] : null))));
    ...
    {
        return new Twig_Source("", "table-slots.twig", "/Users/armi/Code/projects/coccode/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/table-slots.twig");
    }
}
