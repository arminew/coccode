...
/* box.twig */
class __TwigTemplate_9845f3771d424e8bae97cfeb9111bfcf3921041aac5d075fc8146484e8f31de7 extends Twig_Template
{
...
\t\t\t<p>";
        // line 6
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "message", array()), "html", null, true);
        echo "</p>
\t\t</div>
...
\t\t";
        // line 21
        $this->loadTemplate("dialog.twig", "box.twig", 21)->display(array_merge($context, (isset($context["dialog"]) ? $context["dialog"] : null)));
        // line 22
        echo "</div>";
    }
    ...
    {
        return new Twig_Source("", "box.twig", "/Users/armi/Code/projects/coccode/wp-content/plugins/wpml-translation-management/templates/words-count/box.twig");
    }
}
