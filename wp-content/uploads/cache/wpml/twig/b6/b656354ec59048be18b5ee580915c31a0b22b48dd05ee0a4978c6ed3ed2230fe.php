...
class __TwigTemplate_402252884502d227a46bd47c5609958dc2120655934218e7c8b6d9acf95add3b extends Twig_Template
{
...
\t\t";
        // line 76
        if (( !$this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "migrated", array()) == 1)) {
            // line 77
            echo "\t\t\t";
...
\t\t";
        // line 80
        if ((isset($context["hide_backwards_compatibility"]) ? $context["hide_backwards_compatibility"] : null)) {
            echo "<a href=\"#\" class=\"js-wpml-ls-toggle-once\">";
        }
        // line 81
        echo "\t\t\t<label>
\t\t\t\t";
        // line 82
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "options", array()), "label_migrated_toggle", array()), "html", null, true);
        if ((isset($context["hide_backwards_compatibility"]) ? $context["hide_backwards_compatibility"] : null)) {
            echo "<span class=\"otgs-ico-caret-down js-arrow-toggle\"></span>";
        }
        // line 83
...
\t\t";
        // line 85
        $this->loadTemplate("tooltip.twig", "section-options.twig", 85)->display(array_merge($context, array("content" => $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "tooltips", array()), "backwards_compatibility", array()))));
        // line 86
        echo "
\t\t";
        // line 87
...
\t\t\t\t   value=\"0\"";
        // line 91
        if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "migrated", array()) == 0)) {
            echo " checked=\"checked\"";
        }
        // line 92
...
\t\t\t\t";
        // line 95
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "options", array()), "label_skip_backwards_compatibility", array()), "html", null, true);
        echo "
\t\t\t</label>
\t\t</p>
...
\t</div>
    ...
    {
        return new Twig_Source("", "section-options.twig", "/Users/armi/Code/projects/coccode/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/section-options.twig");
    }
}
