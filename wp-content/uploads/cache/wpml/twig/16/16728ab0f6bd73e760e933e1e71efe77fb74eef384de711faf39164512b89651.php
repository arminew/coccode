...
/* layout-main.twig */
class __TwigTemplate_2e10580bda93cae485654765f2cf6e572631e399fbead75c51e13fce8e184672 extends Twig_Template
{
...
\t\t\t<p>";
    ...
    <div id=\"wpml-language-switcher-footer\" class=\"js-wpml-ls-section wpml-section\">
        ...
        echo "
                ";
        // line 52
        $this->loadTemplate("tooltip.twig", "layout-main.twig", 52)->display(array_merge($context, array("content" => $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "tooltips", array()), "show_in_footer", array()))));
        // line 53
        echo "            </h3>
        </div>
    ...
    <div id=\"wpml-language-switcher-post-translations\" class=\"js-wpml-ls-section wpml-section\">
        ...
        echo "
                ";
        // line 66
        $this->loadTemplate("tooltip.twig", "layout-main.twig", 66)->display(array_merge($context, array("content" => $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "tooltips", array()), "section_post_translations", array()))));
        // line 67
        echo "            </h3>
        </div>
    ...
    {
        return new Twig_Source("", "layout-main.twig", "/Users/armi/Code/projects/coccode/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/layout-main.twig");
    }
}
